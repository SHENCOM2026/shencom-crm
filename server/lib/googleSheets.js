...
const HEADERS = [
  ...
  'Forma de pago',
  'Banco', 'Tipo cuenta', 'Número cuenta', 'Cédula dueño cuenta', 'Nombre dueño cuenta',
  'Tarjeta emisor', 'Tarjeta número', 'Tarjeta caducidad',
...
function buildRow(leadId, vendorName, formData) {
  ...
  return [
    ...
    formData.forma_pago || '',
    formData.banco_nombre || '',
    formData.tipo_cuenta || '',
    formData.no_cuenta || '',
    formData.ced_dueno_cta || '',
    formData.nombre_dueno_cta || '',
    formData.tc_emisor || '',
    formData.no_tarjeta || '',
