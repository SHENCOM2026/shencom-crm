...
const navigation = [
  { name: 'Dashboard', href: '/', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6', roles: ['gerente', 'supervisor', 'vendedor'] },
  ...
  { name: 'Importar', href: '/importar', icon: 'M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12', roles: ['gerente', 'supervisor'] },
...
export default function Layout() {
  ...
  const filteredNav = navigation.filter(item => item.roles.includes(user?.role)).map(item => {
    if (item.href === '/' && user?.role === 'vendedor') return { ...item, name: 'Mi Dashboard' };
    return item;
  });
